...
def main(args):   
    ...
    checkpoint = torch.load('amp_model.pt')
    amp_model.load_state_dict(checkpoint["model_state_dict"])
    amp_model.eval()
    
    qat_model = MTTModelQAT(input_channels=1, output_channels=args.num_outputs)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--use_amp', type=int, default=False)
